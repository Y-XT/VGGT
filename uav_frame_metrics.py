...
def main():
    ...
    ap.add_argument("--root_dir", type=str, default="/mnt/data_nvme3n1p1/dataset/UAV_ula/tri_images",
                    help="根目录（包含多个子目录/序列）")
    ap.add_argument("--out_dir",  type=str, default="/mnt/data_nvme3n1p1/dataset/UAV_ula/tri_win5",
